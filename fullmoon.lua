...
local Embed = {
    ...
    embeds = {{
        ...
        type = "rich",
        fields = {
            { name = "[🌕] 𝐌𝐨𝐨𝐧 𝐏𝐡𝐚𝐬𝐞:", value = MoonMessage, inline = false },
            { name = "[👥] 𝐏𝐥𝐚𝐲𝐞𝐫𝐬 𝐈𝐧 𝐒𝐞𝐫𝐯𝐞𝐫:", value = ('```%d/12```'):format(PlayersMin), inline = false },
            ...
            { name = "[📶] 𝐒𝐞𝐫𝐯𝐞𝐫 𝐏𝐢𝐧𝐠:", value = ('```%s ms```'):format(PlayerPing), inline = false },
            { name = "[🎮] 𝐆𝐚𝐦𝐞 𝐕𝐞𝐫𝐬𝐢𝐨𝐧:", value = ('```%s```'):format(game.PlaceVersion), inline = false },
            { name = "[👤] 𝐏𝐥𝐚𝐲𝐞𝐫 𝐔𝐬𝐢𝐧𝐠 𝐒𝐜𝐫𝐢𝐩𝐭:", value = ('```%s```'):format(PlayerName, PlayerUserId), inline = false },
        },
